            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    <div id="logo">
                        ...
                        @else
                            <a href="{{ url('/home') }}" class="standard-logo" data-dark-logo="{{ asset('images/logo-dark.png') }}"><img src="{{ asset('images/logo.png') }}" alt="Canvas Logo"></a>
                            <a href="{{ url('/home') }}" class="retina-logo" data-dark-logo="{{ asset('images/logo-dark@2x.png') }}"><img src="{{ asset('images/logo@2x.png') }}" alt="Canvas Logo"></a>
                        @endif
                    </div><!-- #logo end -->
                            ...
                            @else
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="{{ url('profile') }}/{{ Auth::User()->id }}"><i class="fa fa-btn fa-sign-out"></i>Profil</a></li>
        ...
        <footer id="footer" class="dark">
            ...
            <div id="copyrights">
                ...
                <div class="container clearfix">
                    ...
                    <div class="col_half">
                        Copyrights &copy; 2016 All Rights Reserved by Terserah.<br>
